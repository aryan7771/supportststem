...
if (!isset($_SESSION['ID'])){
 ...
 $sql = "Select * FROM technician WHERE UserID = '$TID'";
                            ...
                            <div class="form-panel">
                                ...
                                <form class="form-horizontal style-form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
                                    <div class="form-group" style="display:none;">
                                            ...
                                            <input type="text" class="form-control" name="TID" value="<?php echo $TID; ?>">
...
elseif(preg_match('/^[0-9]{10}$/', $Mobile)) {
    ...
    echo $sql = "UPDATE technician SET FirstName='$FirstName', LastName='$LastName',Mobile='$Mobile',Password='$Password', Address='$Address', Country='$Country', State='$State', City='$City', Pincode='$Pincode', TechnicianRole='$Role', Email='$Email', UserStatus='$Status' Where UserID='$TID'";

    mysql_query($sql)or die(mysql_error());
    echo '<script type="text/javascript">
           window.location = "http://www.samasyaniwaran.com/app/admin/managetech.php"
      </script>';
    }
   else{
