      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa "></i> Add Complain</h3>
                ...
                echo "<option value='$CustomerID'>".$FirstName." ".$LastName." | ".$UserName."</option>";
...
<div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <select name="MainService"  required="required" class="form-control">
                                                <?php
            ...
            ?>
                 ...
                 $LastName     = $row['LastName'];
                 $UserName     = $row['UserName'];
                 $TechnicianRole     = $row['TechnicianRole'];
                 
                
                 
                echo "<option value='$TechnicianID'>".$FirstName." ".$LastName." | ".$UserName." | ".$TechnicianRole."</option>";
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea class="form-control" name="UserRemark"> </textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 col-sm-2 control-label">Technician Remark</label>
                                        <div class="col-sm-10">
                                            <textarea class="form-control" name="TechRemark"> </textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="date" class="form-control" name="CompletionDate"></input>
                                        </div>
                                    </div>
                                    <div class="form-group">
...
$Customer = $_POST['Customer'];
 ...
 if ($Customer==""){echo '<script>alert("Please Select Customer");</script>';}
  ...
  //else if($Technician==""){echo '<script>alert("Please Enter Mobile No.");</script>';}
  //else if($UserRemark==""){echo '<script>alert("Please Enter Username");</script>';}
 // else if($TechRemark==""){echo '<script>alert("Please Enter Password");</script>';}
  //else if($Cost==""){echo '<script>alert("Please Enter Password");</script>';}
 ...
 $sql="INSERT INTO complaints (CustomerID, MainServiceID, ComplaintDate, AssignedTID, ComplaintRemarkUser, ComplaintRemarkTech, ComplaintCost, CompletionDate, ComplaintStatus) VALUES ('$Customer','$MainService','$Date','$Technician','$UserRemark','$TechRemark','$Cost','$CompletionDate','$Status')";
...
//echo $sql="INSERT INTO complaints (CustomerID, MainServiceID, ComplaintDate, AssignedTID, ComplaintRemarkUser, ComplaintRemarkTech, ComplaintCost, CompletionDate, ComplaintStatus) VALUES ('$Customer','$MainService','$Date','$Technician','$UserRemark','$TechRemark','$Cost','$CompletionDate','$Status')";
