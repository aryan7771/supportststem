                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                ...
                                <li class="active"><a href="addcust.php">Add</a></li>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa "></i> Add Customer</h3>
...
if($count==1 || $count>=1){
    ...
    echo $sql = "INSERT INTO customers (UserName, Password, FirstName, LastName, Mobile, Country, State, City, Address, Pincode, UserStatus, Email) VALUES ('$UserName', '$Password', '$FirstName', '$LastName', '$Mobile', '$Country', '$State', '$City', '$Address', '$Pincode', '$Status', '$Email')";
