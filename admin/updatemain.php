...
echo $sql="Select * from mainservices where MainServiceID='$MID'";
                 $result = mysql_query($sql)or die(mysql_error());   
                  while($row = mysql_fetch_array($result)){
					 $ServiceName = $row['MainServiceName'];
					 $ServiceDesc =  $row['MainServiceDesc'];
                      $ServiceID =  $row['MainServiceID'];
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa "></i> Update Main Services</h3>
				<!-- row -->
                            ...
                            <div class="form-panel">
                                ...
                                <form class="form-horizontal style-form"  action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                        <input type='text' style='display:none;' class='form-control' name='ServiceID' value='<?php echo $MID;?>'  >
...
<textarea  class='form-control' name='ServiceDesc' ><?php echo $ServiceDesc; ?> </textarea>
...
echo $sql="UPDATE MainServices SET MainServiceName='$ServiceName',MainServiceDesc='$Description',MainServiceStatus='-' WHERE MainServiceID='$ServiceID'";
  mysql_query($sql)or die(mysql_error());
  echo '<script type="text/javascript">
           window.location = "http://www.samasyaniwaran.com/app/admin/managemain.php"
      </script>';
  }
