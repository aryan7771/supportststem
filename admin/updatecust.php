      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa "></i> Update Customer</h3>
...
elseif(preg_match('/^[0-9]{10}$/', $Mobile)) {
    ...
    echo $sql = "UPDATE customers SET FirstName='$FirstName', LastName='$LastName',Mobile='$Mobile',Password='$Password', Address='$Address', Country='$Country', State='$State', City='$City', Pincode='$Pincode', Email='$Email', UserStatus='$Status' Where CustomerID='$CID'";

    mysql_query($sql)or die(mysql_error());
   
    echo '<script type="text/javascript">
           window.location = "http://www.samasyaniwaran.com/app/admin/managecust.php"
      </script>';
    }
   else{
