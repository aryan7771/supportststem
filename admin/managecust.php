...
<html lang="en">
        ...
        <section id="container">
                ...
                <div id="sidebar" class="nav-collapse ">
                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li class="active"><a href="Managecust.php">Manage</a></li>
            ...
            <section id="main-content">
                <section class="wrapper">
                    <h3><i class="fa "></i> Manage Customers</h3>
                    <!-- row -->
                    <div class="row mt">
                        <div class="col-md-12">
 ...
 $sql = "SELECT * FROM customers";
                ...
                //echo "<td >".$sr."</td><td style='display:none;'>".$Subscription_ID."</td><td style='display:none;'>".$ID."</td><td >".$Domain."</td><td >".$Ftp_Host."</td><td >".$Ftp_User."</td><td ><a class='btnn btn-2 btn-2h' href='backftp.php?ID=$ID'  style='width:73px'> Backup </a><a class='btnn btn-2 btn-2h' id='secure.php?ID=$ID&Status=allow' onClick='secure(this.id)' style='width:73px'> Allow </a><a class='btnn btn-2 btn-2h' id='secure.php?ID=$ID&Status=deny' onClick='secure(this.id)' style='width:73px'> Deny </a></td>";
                 echo "<td>".$FirstName." ".$LastName."</td><td>".$UserName."</td><td>".$Mobile."</td><td>".$Address."</td><td>".$Email."</td><td>".$Status."</td><td><a <a href='updatecust.php?CID=$UserID' class='btn btn-primary btn-xs'><i class='fa fa-pencil'></i></a><a href='delete.php?CID=$UserID&CNAM=$UserName' class='btn btn-danger btn-xs'><i class='fa fa-trash-o '></i></a></td>";
                         echo"</tr>" ;      
                } 
