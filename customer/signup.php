...
if(isset($_POST['Submit'])){ 
  ...
  else if($City==""){echo '<script>alert("Please Enter City");</script>';}
  else if($Pincode==""){echo '<script>alert("Please Enter Pincode");</script>';}
...
if($count==1 || $count>=1){
    ...
    echo '<script>alert("Username Already Exist");</script>';
     ...
     $sql = "INSERT INTO customers (UserName, Password, FirstName, LastName, Mobile, Country, State, City, Address, Pincode, UserStatus, Email) VALUES ('$UserName', '$Password', '$FirstName', '$LastName', '$Mobile', '$Country', '$State', '$City', '$Address', '$Pincode', '$Status', '$Email')";
...
echo '<script>alert("Please Enter a Valid Mobile No.");</script>';
      ...
      *********************************************************************************************************************************************************** -->
	  ...
	  <div id="login-page">
	  	<div class="container">
		      ...
		      <form class="form-login1 form-login " action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
		        ...
		        <div class="login-wrap">
		            ...
		            <br>
                    <input name="Mobile" type="text" class="form-control" placeholder="Mobile" autofocus>
		            <br>
