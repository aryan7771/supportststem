...
<html lang="en">
  ...
  //else if($Role==""){echo '<script>alert("Please Enter Role");</script>';}
   ...
   elseif(preg_match('/^[0-9]{10}$/', $Mobile)) {
     ...
     $sql = "UPDATE customers SET FirstName='$FirstName', LastName='$LastName',Mobile='$Mobile', Address='$Address', Country='$Country', State='$State', City='$City', Pincode='$Pincode', Email='$Email' Where CustomerID='$CID'";
 ...
 $sql = "Select * FROM customers WHERE CustomerID = '$CID'";
     ...
     echo '<script type="text/javascript">
           window.location = "http://www.samasyaniwaran.com/app/customer/profile.php"
      </script>';
    }
