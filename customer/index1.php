      ...
      <section id="main-content">
          <section class="wrapper">
              <div class="row"><div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                             <a href="addcomp.php" class="btn btn-theme">Add Complaint</a>
                                        </div>
                                    </div></div>
              <div class="row">
                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
                              ...
                              $sr=0;
                               $CID = $_SESSION['CID'];
                               $sql = "SELECT * FROM complaints where CustomerID='$CID'";
                ...
                echo " <td>".$ComplaintStatus."</td>";
                  echo "<td> <a href='viewcomp.php?CID=$CustomerID&CCID=$ComplainID' class='btn btn-primary btn-xs'><i class='fa fa-pencil'></i></a></td>";
                 echo "<td> <a href='delete.php?CID=$CustomerID&CCID=$ComplainID' class='btn btn-danger btn-xs'><i class='fa fa-trash-o '></i></a></td>";
